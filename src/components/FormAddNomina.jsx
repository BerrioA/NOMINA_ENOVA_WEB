  ...
  return (
    <div className="container_principal mx-auto p-4">
      <form onSubmit={guardarNomina}>
        ...
        <p className="text-center text-xl">Información nómina del empleado </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-4">
          <InputSingle
            ...
            value={(valortotalclasesapoyosena =
              clasesapoyosena * valorclaseapoyosena).toLocaleString("es-CO", {
              style: "currency",
              currency: "COP",
              minimumFractionDigits: 0,
            })}
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-4">
          ...
          <div className="flex sm:flex-1 gap-4">
            <InputSingle
              ...
              onChange={(e) => setValorTotalClasesInstructor(e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-4">
          ...
          <InputSingle
            ...
            value={(saldopendiente =
              totalpagar + Number(pagosadicionalespendientes)).toLocaleString(
              "es-CO",
              {
                style: "currency",
                currency: "COP",
